...
**Key Finding:** The analysis reveals a massive "Mega-Amendment Shift." While the sheer volume of new administrative actions remains stable, the government is increasingly concentrating capital into expensive, multi-year service contracts—heavily driven by the Department of National Defence.
...
* `outputs/`: Includes small, exported supplementary tables (e.g., spending by commodity type, deduplication samples) referenced in the main report.
